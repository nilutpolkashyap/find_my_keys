...
extern const unsigned char previewR[120264];  // Referring to external data (Dingdong audio files are stored inside).   引用外部数据（dingdong音频文件存储在内）
...
void DisplayText(void){
  M5.Lcd.drawString("Connect to Bluetooth", 10, 90, 2);
//  M5.Lcd.print("Device ON\n");
//  M5.Lcd.print("Bluetooth ON");
  M5.Lcd.drawString("FIND MY KEYS", 40, 10, 2);
  M5.Lcd.drawString("Bluetooth ON", 10, 60, 2);
}
